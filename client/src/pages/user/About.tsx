  ...
  const passions = [
    {
      icon: BookOpen,
      title: "Avid Reader",
      description: "Always lost in a good book—fiction, self-help, or anything that sparks curiosity."
    },
    {
      icon: Pen,
      title: "Storyteller",
      description: "I believe everyone has a story worth telling, and I love sharing mine."
    },
    {
      icon: Camera,
      title: "Life Observer",
      description: "Finding beauty in everyday moments and turning them into words."
    }
  ];
        ...
        <section className="relative overflow-hidden py-24 md:py-32">
          ...
          <div className="container px-4">
            <div className="flex flex-col items-center text-center max-w-3xl mx-auto">
              ...
              >
                Hey, I'm the Voice Behind <span className="text-orange-600 underline decoration-orange-200 underline-offset-8">Bearbubbles</span>
              </motion.h1>
              ...
              >
                Welcome to my little corner of the internet where I share thoughts, stories, 
                and everything in between. Grab a cup of coffee and stay a while! ☕
              </motion.p>
            </div>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
              ...
              >
                ...
                <div className="space-y-5 text-muted-foreground text-lg leading-relaxed">
                  <p>
                    I've always been fascinated by the power of words. Growing up, I filled 
                    countless journals with thoughts, dreams, and observations about the world around me.
                  </p>
                  <p>
                    <strong className="text-foreground">My Safari</strong> was born from a desire to share those musings with others—to connect 
                    with like-minded souls who appreciate life's little moments and big questions alike.
                  </p>
                  <p>
                    The butterfly in my logo? It represents transformation. Just like a 
                    butterfly, I believe we're all constantly evolving and becoming better 
              ...
              >
                ...
                <div className="relative grid grid-cols-2 gap-4">
                  {funFacts.map((item, index) => (
                    <div key={index} className="flex flex-col items-center p-6 rounded-2xl bg-muted/50 border border-transparent hover:border-orange-200 transition-all group">
                      <div className="text-4xl mb-3 group-hover:scale-110 transition-transform">{item.emoji}</div>
                      <div className="text-sm font-medium text-muted-foreground text-center">{item.fact}</div>
                    </div>
                  ))}
                </div>
              </motion.div>
          ...
          <div className="container px-4">
            <div className="text-center max-w-2xl mx-auto mb-16">
              <div className="flex items-center justify-center gap-2 text-orange-600 mb-4">
                ...
                <span className="text-sm font-bold uppercase tracking-widest">What Drives Me</span>
              </div>
          ...
          <div className="container px-4">
            <div className="max-w-3xl mx-auto text-center">
              <div className="flex items-center justify-center gap-2 text-orange-600 mb-6">
                ...
                <span className="text-sm font-bold uppercase tracking-widest text-foreground">What to Expect</span>
              </div>
              <h2 className="text-4xl font-bold mb-8 leading-tight">Here You'll Find...</h2>
              <p className="text-xl text-muted-foreground leading-relaxed mb-10 italic">
                ...
                reflections on navigating this beautiful, messy thing called life. 
                I write about what moves me, and I hope it resonates with you too.
              </p>
